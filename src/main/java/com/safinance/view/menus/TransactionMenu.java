...
public class TransactionMenu implements BaseMenu {
    ...
    public TransactionMenu(User user, AccountUseCase accountUseCase, TransactionUseCase transactionUseCase) {
        this.user = user;
        this.accountUseCase = accountUseCase;
        this.transactionUseCase = transactionUseCase;

        registerTransition("1", () -> new DepositAction(user, accountUseCase, transactionUseCase), transitions);

        registerTransition("2", () -> new WithdrawAction(user, accountUseCase, transactionUseCase), transitions);

        registerTransition("3", () -> new TransferAction(user, accountUseCase, transactionUseCase), transitions);
