...
public class AccountSelectionMenu implements BaseMenu {
     ...
     */
    public AccountSelectionMenu(User user, User accountOwner, UserUseCase userUseCase, BankUseCase bankUseCase, AccountUseCase accountUseCase) {
        this.user = user;
    ...
    public void renderHeader(PromptService promptService) {
        ...
        transitions.put("0", () -> new ManageAccountsMenu(user, accountOwner, userUseCase, bankUseCase, accountUseCase));
        ...
        for (SavingsAccount sa : savingsAccounts) {
            ...
            transitions.put(String.valueOf(chosenIndex), () -> new ApplyYieldAction(user, accountOwner, sa, userUseCase, bankUseCase, accountUseCase));
            index++;
        }
