 ...
 */
public final class ExpenseTransaction implements Transaction {
    ...
    /**
     * Returns the amount as a negative value because account processing
     * applies transaction amounts directly to the balance.
     */
    @Override
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ExpenseTransaction other)) {
            return false;
        }
